...
description: 
published: true
date: 2025-06-09T09:54:41.143Z
tags: 
editor: ckeditor
dateCreated: 2023-11-07T09:19:58.550Z
-->
...
> [Скачать файл с примерами дополнительных реквизитов](https://mobi-c.ru/arc/help/unf-requisites)
> 
> Загрузить примеры можно нажав кнопку **Добавить из файла** и выбрав скачанный файл.
> 
> В верхнем тулбаре нажмите кнопку **Загрузить(обновить пример)** что бы посмотреть встроенные примеры доп реквизитов.
...
**обработка.ПолучитьКонтрагентаИДоговор(ОбщийКод, Контрагент, Договор) -** По идентификатору клиента Моби-С возвращает ссылки на контрагента и договор. Доступно только в "**Обработка значения реквизита в 1С**"

**обработка.ПолучитьНоменклатуруИХарактеристику(ОбщийКод, Номенклатура, Характеристика, Партия) -** По идентификатору товара Моби-С возвращает ссылки на номенклатуру, характеристику и партию в 1С. Доступно только в "**Обработка значения реквизита в 1С**"
...
> **Методы получения кодов пар Контрагент+Договор, Номенклатура+Характеристика, больше не используются, требуемые коды добавлены в списки значений – Клиенты, Номенклатуры.**
